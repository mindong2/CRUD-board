...
const Register = () => {
    ...
    const registerFn = async (e) => {
        ...
        if (Password.length < 8 || PWConfirm < 8) {
            return alert("비밀번호는 8자리 이상으로 생성해주세요.");
        }
        ...
        await createdUser.user.updateProfile({
            displayName: Name,
            photoURL: "https://kr.object.ncloudstorage.com/react-crud/post/profile.png",
        });
        ...
        <LoginInputDiv>
            <form>
                <div className="input_box">
                    ...
                    <p className="NameChkResult" style={{ marginTop: "2rem", fontSize: "2rem" }}>
                        {nameChkResult}
                    </p>
                </div>
                <div className="input_box">
                ...
                <div className="btn_area">
                    {/* <button disabled={Flag} onClick={(e) => registerFn(e)}> ->파이어베이스 월 한도 유저가 1명남아서 잠시 주석처리 */}
                    <button disabled onClick={(e) => registerFn(e)}>
                        회원가입
                    </button>
                </div>
            </form>
